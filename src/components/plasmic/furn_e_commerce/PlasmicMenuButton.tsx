...
import * as sty from "./PlasmicMenuButton.module.css"; // plasmic-import: RJ-B7u7GdkP5IM/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: hPBjdu49qUmYo6/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: tSw5yUEvbS6xXa/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, "expanded", "expanded") ? false : true) ? (
          <BarsIcon
            className={classNames(defaultcss.all, sty.svg__rbUn3, {
              [sty.svg__expanded__rbUn3FA1Z2]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant(variants, "expanded", "expanded") ? true : false) ? (
          <TimesIcon
            className={classNames(defaultcss.all, sty.svg__nbRPa, {
              [sty.svg__expanded__nbRPafA1Z2]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
