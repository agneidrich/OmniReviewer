...
import * as sty from "./PlasmicBlogPost.module.css"; // plasmic-import: FqHwe52w8GjX8c/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__zF2G, {
            [sty.freeBox__long__zF2GdLqK]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__uioPn)}
                role={"img"}
                src={b1AZZ1VUwi0Au0}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__ao2UI, {
          [sty.freeBox__long__ao2UIdLqK]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
